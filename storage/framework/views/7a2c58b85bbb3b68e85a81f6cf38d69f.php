...
<div class="card">
    <div class="logo-wrap">
        <div class="logo-icon">
            <div class="logo-icon-inner">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Fast Order Logo">
            </div>
        </div>
        <div class="logo-text">
            <h1>Fast Order</h1>
    ...
    <p class="footer-note">محمي بواسطة <span>Fast Order Security</span> © <?php echo e(date('Y')); ?></p>
</div>
</body>
</html>
<?php /**PATH E:\programing\flutter project\fast order\resources\views/auth/login-superadmin.blade.php ENDPATH**/ ?>