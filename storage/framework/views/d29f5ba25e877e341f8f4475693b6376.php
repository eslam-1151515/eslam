...
<?php $component->withAttributes([]); ?>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-gray-50" id="banner-row-<?php echo e($banner->id); ?>">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <img src="<?php echo e(asset('storage/' . $banner->image_path)); ?>"
                                                    alt="<?php echo e($banner->title); ?>" class="h-16 w-24 object-cover rounded shadow-sm">
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">
                                                    <?php echo e($banner->title ?: 'بدون عنوان'); ?>
                                            ...
                                            <td class="px-6 py-4 text-sm text-gray-500">
                                                <?php if($banner->link): ?>
                                                    <a href="<?php echo e($banner->link); ?>" target="_blank"
                                                        ...
                                                        <?php echo e(Str::limit($banner->link, 40)); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input type="checkbox" <?php echo e($banner->is_active ? 'checked' : ''); ?>
                                                        ...
                                                        class="sr-only peer toggle-switch" data-id="<?php echo e($banner->id); ?>"
                                                        onchange="toggleBanner(<?php echo e($banner->id); ?>)">
                                                    <div
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <button onclick="openEditModal(<?php echo e($banner->id); ?>)"
                                                ...
                                                <button onclick="deleteBanner(<?php echo e($banner->id); ?>)"
    ...
    <div id="addModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50"
        ...
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-2/3 lg:w-1/2 shadow-lg rounded-lg bg-white">
            ...
            <form action="<?php echo e(route('banners.store')); ?>" method="POST" enctype="multipart/form-data" id="addBannerForm">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
    ...
    <script>
        const banners = <?php echo json_encode($banners, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH E:\programing\flutter project\fast order\resources\views\banners\index.blade.php ENDPATH**/ ?>