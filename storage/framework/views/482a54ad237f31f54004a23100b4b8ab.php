...
<head>
    ...
    <title>العروض والتخفيضات الحصرية - <?php echo e($tenant->name ?? 'فاست أوردر'); ?></title>
    <meta name="description" content="اكتشف أقوى عروض الفلاش سيل والخصومات الموسمية الحصرية من <?php echo e($tenant->name ?? 'متجرنا'); ?>. تسوق الآن بأفضل الأسعار قبل نفاد الكمية!">
    ...
    <header class="navbar">
        <div class="nav-container">
            <a href="/shop/index.html" class="logo">
                ...
                <span><?php echo e($tenant->name ?? 'فاست أوردر'); ?></span>
            </a>
    ...
    <section class="filter-section">
        <div class="filter-tabs" id="promoTabs">
            <button class="tab-btn active" data-target="all">
                ...
                <span>كل العروض</span>
                <span class="tab-badge"><?php echo e($promotions->count()); ?></span>
            </button>
            <button class="tab-btn" data-target="flash_sale">
                <i class="fa-solid fa-bolt"></i>
                <span>عروض الفلاش سيل</span>
                <span class="tab-badge"><?php echo e($flashSales->count()); ?></span>
            </button>
            <button class="tab-btn" data-target="seasonal">
                <i class="fa-solid fa-leaf"></i>
                <span>عروض موسمية</span>
                <span class="tab-badge"><?php echo e($seasonalPromos->count()); ?></span>
            </button>
            <button class="tab-btn" data-target="clearance">
                <i class="fa-solid fa-tag"></i>
                <span>تصفية ومخفّضات</span>
                <span class="tab-badge"><?php echo e($clearancePromos->count()); ?></span>
            </button>
            <button class="tab-btn" data-target="bundle">
                <i class="fa-solid fa-box-open"></i>
                <span>عروض الحزم</span>
                <span class="tab-badge"><?php echo e($bundlePromos->count()); ?></span>
            </button>
        </div>
    </section>
        ...
        <?php else: ?>
            <div id="promotionsContainer">
                <?php $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="promo-block" data-type="<?php echo e($promo->type); ?>">
                        <div class="promo-header <?php echo e($promo->type === 'flash_sale' ? 'flash' : ''); ?>">
                            <div class="promo-info">
                                <h3>
                                    <?php if($promo->type === 'flash_sale'): ?>
                                        <i class="fa-solid fa-bolt" style="color: var(--fire);"></i>
                                    <?php elseif($promo->type === 'seasonal'): ?>
                                        <i class="fa-solid fa-leaf" style="color: var(--emerald);"></i>
                                    <?php elseif($promo->type === 'clearance'): ?>
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem; margin-top: 0.5rem;">
                                    <span class="type-tag type-<?php echo e($promo->type); ?>"><?php echo e($promo->type_name_arabic); ?></span>
                                    <span class="discount-highlight">خصم <?php echo e($promo->discount_badge_text); ?></span>
                                </div>
                            </div>

                            <?php if($promo->ends_at): ?>
                                <div class="countdown-wrapper" data-countdown="<?php echo e($promo->ends_at->toIso8601String()); ?>">
                        ...
                        <!-- ─── Products Grid ─── -->
                        <?php if($promo->products_list && $promo->products_list->count() > 0): ?>
                            <div class="products-grid">
                                <?php $__currentLoopData = $promo->products_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="product-card">
                                        <!-- Badges -->
                                        <div class="badge-discount">
                                            <i class="fa-solid fa-tag"></i>
                                            <span><?php echo e($product->discount_badge ?? $promo->discount_badge_text); ?></span>
                                        </div>
                                        <?php if($product->saved_percentage && $product->saved_percentage !== '0%'): ?>
                                            <div class="badge-save">وفر <?php echo e($product->saved_percentage); ?></div>
                                        <?php endif; ?>

                                        <div class="product-img-wrap">
                                            <?php if($product->main_image_path || $product->image_url): ?>
                                                <img src="<?php echo e($product->main_image_path ?? $product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="product-img" loading="lazy">
                                            <?php else: ?>
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="price-container">
                                                <span class="new-price"><?php echo e(number_format($product->discounted_price ?? $product->price, 0)); ?> ج.م</span>
                                                <?php if(($product->discounted_price ?? $product->price) < $product->price): ?>
                                                    <span class="old-price"><?php echo e(number_format($product->price, 0)); ?> ج.م</span>
                                                <?php endif; ?>
                                            </div>

                                            <button class="btn-add-cart" onclick="addToCart(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>', <?php echo e($product->discounted_price ?? $product->price); ?>)">
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\default\promotions.blade.php ENDPATH**/ ?>