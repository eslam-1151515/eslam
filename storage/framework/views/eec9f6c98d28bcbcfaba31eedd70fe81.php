<?php $__env->startSection('title', 'اتفاقية مستوى الخدمة (SLA) | أوردر سيف (Order Saif) - استقرار وضمان لأعمالك'); ?>

<?php $__env->startSection('meta_description', 'تعرف على التزامات منصة أوردر سيف بخصوص وقت تشغيل الخوادم (Uptime)، والتعويضات المستحقة، ومستويات الدعم الفني لضمان استمرارية متجرك الإلكتروني.'); ?>
        ...
        <div class="glass-card p-8 md:p-12 rounded-3xl border-white/5 space-y-10 leading-relaxed text-gray-300">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm sm:text-base">
                    تلتزم منصة أوردر سيف (Order Saif) بتوفير معدل وقت تشغيل خوادم وسيرفرات لا يقل عن <strong class="text-emerald-400 font-mono">99.9%</strong> على مدار الشهر الميلادي. يُقاس وقت التشغيل من خلال أنظمة المراقبة الخارجية المعتمدة لدينا، ولا يشمل فترات الصيانة المجدولة مسبقاً.
                </p>
            </div>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/sla.blade.php ENDPATH**/ ?>