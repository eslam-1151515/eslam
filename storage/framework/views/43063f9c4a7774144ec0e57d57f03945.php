<?php $__env->startSection('title', 'مركز المساعدة والشروحات | أوردر سيف (Order Saif) - دليلك للنجاح'); ?>

<?php $__env->startSection('meta_description', 'تصفح شروحات ودليل استخدام منصة أوردر سيف. تعلم كيفية إنشاء متجرك، وإضافة منتجاتك، وتفعيل إعدادات الدفع والشحن، وربط دومين مخصص بسهولة.'); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="p-8 sm:p-12 rounded-3xl bg-gradient-to-tr from-brand-950/40 via-dark-card to-pink-950/20 border border-white/10 space-y-6">
            ...
            <div class="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="<?php echo e(route('main.contact')); ?>" class="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-sm text-white bg-brand-600 hover:bg-brand-500 transition-all flex items-center justify-center gap-2">
                    <i class="fa-solid fa-envelope"></i>
                    <span>فتح تذكرة دعم فني</span>
                </a>
                <a href="<?php echo e($whatsappContact?->action_url ?? '#'); ?>" target="_blank" class="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-sm text-white bg-emerald-600 hover:bg-emerald-500 transition-all flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/help.blade.php ENDPATH**/ ?>