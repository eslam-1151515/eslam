...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <form method="POST" action="<?php echo e(route('products.update', $product)); ?>" class="text-right" enctype="multipart/form-data" id="productEditForm">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <div class="mb-4">
                    <label class="block mb-1">اسم المنتج</label>
                    <input type="text" name="name" value="<?php echo e(old('name', $product->name)); ?>" class="w-full border rounded p-2">
                ...
                <div class="mb-4">
                    ...
                    <select name="category_id" class="w-full border rounded p-2 appearance-none bg-[length:16px_16px] bg-[left_0.75rem_center] pl-8 pr-2" style="background-image:url('data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'16\' height=\'16\' viewBox=\'0 0 20 20\' fill=\'%23666\'><path d=\'M5.23 7.21a.75.75 0 011.06.02L10 10.94l3.71-3.71a.75.75 0 111.06 1.06l-4.24 4.24a.75.75 0 01-1.06 0L5.21 8.29a.75.75 0 01.02-1.08z\'/></svg>');">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>" <?php if(old('category_id', $product->category_id)==$id): echo 'selected'; endif; ?>><?php echo e($name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_before" value="<?php echo e(old('price_before', $product->price_before)); ?>" class="w-full border rounded p-2">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_after" value="<?php echo e(old('price_after', $product->price_after ?: $product->price)); ?>" class="w-full border rounded p-2">
                        <?php $__errorArgs = ['price_after'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-red-600 text-sm mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4 p-4 border border-blue-100 bg-blue-50 rounded-lg">
                    ...
                    <input type="hidden" name="price_tiers_json" id="price_tiers_json" value="<?php echo e(old('price_tiers_json', $product->price_tiers)); ?>">
                </div>
                <div class="mb-4">
                    <label class="block mb-1">الكمية</label>
                    <input type="number" name="stock" value="<?php echo e(old('stock', $product->stock)); ?>" class="w-full border rounded p-2">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input type="radio" id="free_shipping" name="shipping_type" value="free" 
                                   ...
                                   <?php echo e(old('shipping_type', $product->shipping_type ?? 'free') == 'free' ? 'checked' : ''); ?>>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input type="radio" id="governorate_shipping" name="shipping_type" value="governorate" 
                                       class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                                       <?php echo e(old('shipping_type', $product->shipping_type ?? 'free') == 'governorate' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="w-full border rounded p-2" rows="4"><?php echo e(old('description', $product->description)); ?></textarea>
                </div>
                ...
                <div class="mb-4">
                    <div class="flex items-center mb-2">
                        <input type="checkbox" id="enableSizes" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded ml-2" <?php echo e(!empty($existingSizes) ? 'checked' : ''); ?>>
                        <label for="enableSizes" class="font-medium">المقاسات</label>
                    </div>
                    <div id="sizesContainer" class="<?php echo e(empty($existingSizes) ? 'hidden' : ''); ?>">
                        <div id="sizesList" class="space-y-2 mb-2">
                            <?php $__currentLoopData = $existingSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center gap-2">
                                <input type="text" name="sizes[]" value="<?php echo e($size); ?>" placeholder="مثال: L, XL, 42" 
                ...
                <div class="mb-4">
                    <div class="flex items-center mb-2">
                        <input type="checkbox" id="enableColors" class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded ml-2" <?php echo e(!empty($existingColors) ? 'checked' : ''); ?>>
                        <label for="enableColors" class="font-medium">الألوان</label>
                    </div>
                    <div id="colorsContainer" class="<?php echo e(empty($existingColors) ? 'hidden' : ''); ?>">
                        <div id="colorsList" class="space-y-2 mb-2">
                            <?php $__currentLoopData = $existingColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <div class="flex items-center gap-2">
                                <input type="text" name="colors[]" value="<?php echo e($color); ?>" placeholder="مثال: أحمر, أزرق, أسود" 
                                       class="flex-1 border rounded-lg p-2 focus:ring-2 focus:ring-indigo-200">
                                <button type="button" onclick="removeItem(this)" 
                                        class="px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                ...
                <div class="mb-4 mt-6 border-t pt-4">
                    <input type="hidden" name="variants_stock" id="variants_stock_json" value="<?php echo e(old('variants_stock', $product->variants_stock)); ?>">
                ...
                <div class="mb-4">
                    ...
                    <?php if($product->main_image_path): ?>
                        <div class="mb-2"><img src="<?php echo e(asset('storage/'.$product->main_image_path)); ?>" alt="الصورة الحالية" class="h-24 w-24 object-cover rounded border"></div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <?php if($product->images && $product->images->count()): ?>
                        <div class="mb-2 flex flex-wrap gap-3">
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="relative inline-block">
                                    <img src="<?php echo e(asset('storage/'.$img->image_path)); ?>" alt="صورة فرعية للمنتج <?php echo e($product->name); ?>" class="h-20 w-20 object-cover rounded border">
                                    <button type="button" class="absolute top-1 left-1 h-7 w-7 rounded-full bg-red-600 text-white flex items-center justify-center shadow-md ring-2 ring-white" title="حذف" onclick="deleteProductImage('<?php echo e(route('products.images.destroy', [$product, $img])); ?>')">✕</button>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 flex items-center justify-between">
                    <a href="<?php echo e(route('products.index')); ?>" class="px-5 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">رجوع</a>
...
// إدارة شرائح الأسعار
let priceTiers = <?php echo old('price_tiers', $product->price_tiers ?? '[]'); ?>;
...
</script><?php /**PATH E:\programing\flutter project\fast order\resources\views\products\edit.blade.php ENDPATH**/ ?>