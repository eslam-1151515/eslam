<?php $__env->startSection('title', 'من نحن | أوردر سيف (Order Saif) - ثورة في التجارة الإلكترونية العربية'); ?>

<?php $__env->startSection('meta_description', 'تعرف على قصة أوردر سيف ورؤيتنا لتمكين ملايين التجار والشركات الناشئة في العالم العربي من إطلاق متاجرهم الإلكترونية الفائقة السرعة وبدون عمولات.'); ?>
...
<section class="py-16 text-center">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <a href="<?php echo e(route('main.home')); ?>#pricing" class="px-8 py-4 rounded-xl font-bold text-white bg-gradient-to-r from-brand-600 to-pink-600 hover:from-brand-500 hover:to-pink-500 shadow-lg shadow-brand-500/25 hover:shadow-brand-500/40 hover:-translate-y-0.5 transition-all">
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/about.blade.php ENDPATH**/ ?>