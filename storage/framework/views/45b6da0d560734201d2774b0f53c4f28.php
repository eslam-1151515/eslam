...
<head>
    ...
    <title><?php echo e($title ?? 'Order Saif — استعادة كلمة السر'); ?></title>
    ...
    <div class="card">
        <div class="logo-wrap" style="margin-bottom: 24px;">
            <a href="/" style="display: inline-block;">
                <img src="<?php echo e(asset('images/logo2.png')); ?>?v=<?php echo e(time()); ?>" alt="Order Saif" style="max-height: 80px; max-width: 260px; width: auto; height: auto; object-fit: contain; filter: drop-shadow(0 0 20px rgba(99,102,241,0.5));">
            </a>
        </div>
...
<?php /**PATH E:\programing\flutter project\eslam system\resources\views/layouts/guest.blade.php ENDPATH**/ ?>