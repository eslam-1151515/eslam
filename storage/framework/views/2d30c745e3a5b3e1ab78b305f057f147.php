...
<head>
    ...
    <title><?php echo e($landingPage->title ?? 'عرض خاص'); ?> | <?php echo e($tenant->name ?? 'المتجر الرسمي'); ?></title>
    <meta name="description" content="<?php echo e($landingPage->title ?? 'صفحة هبوط حصرية بعروض وخصومات مميزة'); ?>">
...
<body class="theme-default classic-theme">
    ...
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- 1. Hero Section -->
        <?php if($type === 'hero'): ?>
            <section class="hero-section <?php echo e(!empty($section['bg_image']) ? 'has-bg-image' : ''); ?>" style="<?php echo e(!empty($section['bg_image']) ? 'background: linear-gradient(135deg, rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.95)), url('.$section['bg_image'].') center/cover;' : ''); ?>">
                ...
                <a href="<?php echo e($section['cta_link'] ?? '#product-showcase'); ?>" class="btn-cta track-conversion" data-slug="<?php echo e($landingPage->slug); ?>">
        ...
        <?php if($type === 'countdown'): ?>
            <section class="countdown-section">
                ...
                <div class="countdown-grid" data-endtime="<?php echo e($section['end_time'] ?? date('Y-m-d H:i:s', strtotime('+24 hours'))); ?>">
                    <div class="time-box">
            ...
            <section class="showcase-section" id="product-showcase">
                ...
                <div class="product-card">
                    <div class="product-image-wrap">
                        ...
                        <?php endif; ?>
                        <img src="<?php echo e($pImg); ?>" alt="<?php echo e($pName); ?>" class="product-img">
                    </div>
                    ...
                    <div class="product-details">
                        ...
                        <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '<?php echo e($pData['id'] ?? ''); ?>')" class="btn-cta" style="width: 100%;">
                            <span><?php echo e($section['buy_button_text'] ?? 'اطلب الآن واكسب الخصم'); ?></span>
                ...
                <div class="features-grid">
                    <?php $__currentLoopData = ($section['items'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="feature-card">
                            ...
                            <p class="feature-desc"><?php echo e($item['description'] ?? ''); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </section>
        ...
        <?php if($type === 'testimonials'): ?>
            <section class="testimonials-section">
                ...
                <div class="testimonials-grid">
                    <?php $__currentLoopData = ($section['items'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($type === 'cta'): ?>
            <section class="cta-banner">
                ...
                <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '')" class="btn-white">
    ...
    <div class="sticky-bar">
        ...
        <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '')" class="sticky-btn">
            <span>اطلب الآن</span>
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\default\landing.blade.php ENDPATH**/ ?>