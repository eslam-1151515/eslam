<?php $__env->startSection('title', 'مركز المساعدة والشروحات | فاست أوردر (Fast Order) - دليلك للنجاح'); ?>

<?php $__env->startSection('meta_description', 'تصفح شروحات ودليل استخدام منصة فاست أوردر. تعلم كيفية إنشاء متجرك، وإضافة منتجاتك، وتفعيل إعدادات الدفع والشحن، وربط دومين مخصص بسهولة.'); ?>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\fast order\resources\views\platform\help.blade.php ENDPATH**/ ?>