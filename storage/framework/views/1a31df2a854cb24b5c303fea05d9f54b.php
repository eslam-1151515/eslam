...
<div class="card">
    <div class="logo-wrap" style="margin-bottom: 24px;">
        <a href="/" style="display: inline-block;">
            <img src="<?php echo e(asset('images/logo2.png')); ?>?v=<?php echo e(time()); ?>" alt="Order Saif" style="max-height: 85px; max-width: 280px; width: auto; height: auto; object-fit: contain; filter: drop-shadow(0 0 20px rgba(99,102,241,0.5));">
        </a>
    </div>
    ...
    <form method="POST" action="<?php echo e(url('login')); ?>">
        ...
        <div class="row">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="forgot">نسيت كلمة المرور؟</a>
            <?php endif; ?>
        </div>
    ...
    <p class="footer-note">محمي بواسطة <span>Order Saif Security</span> © <?php echo e(date('Y')); ?></p>
</div>
</body>
</html>
<?php /**PATH E:\programing\flutter project\eslam system\resources\views/auth/login-superadmin.blade.php ENDPATH**/ ?>