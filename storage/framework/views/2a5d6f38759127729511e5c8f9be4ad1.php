...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Fast Order — إنشاء حساب تاجر']); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="rtl" style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <div>
            ...
            <div style="display: flex; align-items: center; direction: ltr;">
                ...
                ?>
                <span style="background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.15); border-left: none; padding: 14px 12px; border-top-right-radius: 12px; border-bottom-right-radius: 12px; color: #a5b4fc; font-weight: 600; font-size: 13px;" dir="ltr"><?php echo e($displayDomain); ?></span>
            </div>
