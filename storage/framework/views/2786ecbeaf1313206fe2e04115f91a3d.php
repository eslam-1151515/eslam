...
<head>
    ...
    <meta name="description" content="????? ???? ???? ?????? ??? ????????? ???????? ??????? ?? <?php echo e($tenant->name ?? '??????'); ?>. ???? ???? ????? ??????? ??? ???? ??????!">
                        ...
                        <div class="promo-header <?php echo e($promo->type === 'flash_sale' ? 'flash' : ''); ?>">
                            <div class="promo-info">
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem; margin-top: 0.5rem;">
                                    ...
                                    <span class="discount-highlight">??? <?php echo e($promo->discount_badge_text); ?></span>
                                </div>
                            </div>
                                ...
                                <?php $__currentLoopData = $promo->products_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="product-card">
                                        ...
                                        <?php if($product->saved_percentage && $product->saved_percentage !== '0%'): ?>
                                            <div class="badge-save">??? <?php echo e($product->saved_percentage); ?></div>
                                        <?php endif; ?>
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="price-container">
                                                <span class="new-price"><?php echo e(number_format($product->discounted_price ?? $product->price, 0)); ?> ?.?</span>
                                                <?php if(($product->discounted_price ?? $product->price) < $product->price): ?>
                                                    <span class="old-price"><?php echo e(number_format($product->price, 0)); ?> ?.?</span>
                                                <?php endif; ?>
                                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateTimers() {
                ...
                countdownElements.forEach(el => {
                    ...
                    if (diff <= 0) {
                        el.innerHTML = `<span style="color: #f43f5e; font-weight: 800;"><i class="fa-solid fa-clock-rotate-left"></i> ????? ?????</span>`;
                        return;
                    }
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\starter\promotions.blade.php ENDPATH**/ ?>