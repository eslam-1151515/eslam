<?php $__env->startSection('title', 'من نحن | فاست أوردر (Fast Order) - ثورة في التجارة الإلكترونية العربية'); ?>

<?php $__env->startSection('meta_description', 'تعرف على قصة فاست أوردر ورؤيتنا لتمكين ملايين التجار والشركات الناشئة في العالم العربي من إطلاق متاجرهم الإلكترونية الفائقة السرعة وبدون عمولات.'); ?>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\fast order\resources\views\platform\about.blade.php ENDPATH**/ ?>