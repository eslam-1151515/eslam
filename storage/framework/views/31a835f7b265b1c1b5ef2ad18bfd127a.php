...
<head>
    ...
    <title><?php echo e($landingPage->title ?? '??? ???'); ?> | <?php echo e($tenant->name ?? '?????? ??????'); ?></title>
    <meta name="description" content="<?php echo e($landingPage->title ?? '???? ???? ????? ????? ??????? ?????'); ?>">
...
<body class="theme-starter fast-theme">
    ...
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($type === 'hero'): ?>
            <section class="hero-section <?php echo e(!empty($section['bg_image']) ? 'has-bg-image' : ''); ?>" style="<?php echo e(!empty($section['bg_image']) ? 'background: linear-gradient(135deg, rgba(15, 23, 42, 0.85), rgba(15, 23, 42, 0.95)), url('.$section['bg_image'].') center/cover;' : ''); ?>">
                ...
                <?php endif; ?>
                <h1 class="hero-title"><?php echo e($section['title'] ?? '????? ????? ???????'); ?></h1>
                ...
                <a href="<?php echo e($section['cta_link'] ?? '#product-showcase'); ?>" class="btn-cta track-conversion" data-slug="<?php echo e($landingPage->slug); ?>">
                    <span><?php echo e($section['cta_text'] ?? '???? ???? ????? ?????'); ?></span>
                ...
                <div class="product-card">
                    <div class="product-image-wrap">
                        <?php if($discountPercent > 0): ?>
                            <div class="discount-ribbon">??? <?php echo e($discountPercent); ?>%</div>
                        <?php endif; ?>
                    ...
                    <div class="product-details">
                        ...
                        <div class="price-container">
                            ...
                            <?php if($pOldPrice > $pPrice): ?>
                                ...
                                <span class="save-badge">???? <?php echo e(number_format($pOldPrice - $pPrice)); ?> <?php echo e($curr); ?></span>
                            <?php endif; ?>
                        </div>
                        ...
                        <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '<?php echo e($pData['id'] ?? ''); ?>')" class="btn-cta" style="width: 100%;">
                            <span><?php echo e($section['buy_button_text'] ?? '???? ???? ????? ?????'); ?></span>
                            ...
                            <div class="user-meta">
                                ...
                                <?php else: ?>
                                    <div class="user-avatar" style="background: var(--primary); display:flex; align-items:center; justify-content:center; color:#fff; font-weight:bold;">
                                        <?php echo e(mb_substr($testi['name'] ?? '?', 0, 1)); ?>

                                    </div>
                                <?php endif; ?>
                                <div class="user-info">
                                    <h4><?php echo e($testi['name'] ?? '???? ????'); ?></h4>
                                    <span>
                                        <i class="fa-solid fa-circle-check"></i>
                                        <?php echo e($testi['role'] ?? '????? ????'); ?>
        ...
        <?php if($type === 'cta'): ?>
            <section class="cta-banner">
                <h2 class="cta-title"><?php echo e($section['title'] ?? '?? ??? ???? ??????'); ?></h2>
    ...
    <!-- Footer -->
    <footer>
        <p>???? ?????? ?????? &copy; <?php echo e(date('Y')); ?> ?? <?php echo e($tenant->name ?? '?????? ??????'); ?> | ?? ??????? ?????? Fast Order</p>
    </footer>
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\starter\landing.blade.php ENDPATH**/ ?>