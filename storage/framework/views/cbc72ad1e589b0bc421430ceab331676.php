...
<body class="antialiased selection:bg-brand-500 selection:text-white" x-data="{ mobileMenuOpen: false }">
        ...
        <header class="glass-header sticky top-0 z-50 transition-all duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                ...
                <a href="/" class="flex items-center gap-3 group">
                    <img src="<?php echo e(asset('images/logo2.png')); ?>?v=<?php echo e(time()); ?>" alt="أوردر سيف" class="h-10 w-auto max-h-10 object-contain group-hover:scale-105 transition-transform duration-300">
            ...
            <div x-show="mobileMenuOpen" 
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-white/10 flex flex-col gap-3">
                    ...
                    <a href="<?php echo e(Route::has('register') ? route('register') : url('/register')); ?>" class="w-full py-3 rounded-xl text-center font-bold text-white bg-gradient-to-r from-brand-600 via-indigo-600 to-pink-600 hover:opacity-95 shadow-lg shadow-brand-500/25 transition-all">
                        <i class="fa-solid fa-rocket ml-1.5 mr-1.5"></i> <span x-text="trans('startNow')"></span>
                    </a>
                </div>
            </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="glass-card glass-card-hover rounded-3xl p-8 relative overflow-hidden group reveal <?php echo e($animClass); ?> <?php echo e($delayClass); ?>">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
                        ...
                        <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="relative z-10 flex flex-col items-center text-center group reveal <?php echo e($stepAnim); ?> <?php echo e($stepDelay); ?>">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="glass-card rounded-3xl p-8 border flex flex-col justify-between relative transition-all duration-500 reveal <?php echo e($planAnim); ?> <?php echo e($planDelay); ?> <?php echo e($plan['featured'] ? 'border-brand-500 shadow-2xl dark:shadow-brand-500/20 bg-white dark:bg-gradient-to-b dark:from-dark-card dark:via-brand-950/20 dark:to-dark-card lg:-translate-y-4' : 'border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20'); ?>">
                                ...
                                <div>
                                    ...
                                    <div class="mb-8 pb-6 border-b border-slate-200 dark:border-white/10 flex items-baseline gap-2">
                                        <span class="text-4xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight"><?php echo e($plan['price']); ?></span>
            ...
            <section id="testimonials" class="py-24 bg-slate-50 dark:bg-dark-card/45 border-t border-slate-200 dark:border-white/5 relative overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $testimAnim = ['reveal-flip', 'reveal-up', 'reveal-zoom'][$index % 3];
                                $testimDelay = 'delay-' . (($index + 1) * 100);
                            ?>
                            <div class="glass-card glass-card-hover rounded-3xl p-8 flex flex-col justify-between relative reveal <?php echo e($testimAnim); ?> <?php echo e($testimDelay); ?>">
                ...
                <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="space-y-4">
                        <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <div class="glass-card rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden transition-all duration-300 reveal reveal-up <?php echo e($faqDelay); ?>"
                    ...
                    <div class="mt-12 text-center p-8 rounded-3xl bg-white dark:bg-dark-card border border-slate-200 dark:border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6 reveal reveal-zoom">
                        ...
                        <a href="<?php echo e($whatsappContact?->action_url ?? '#'); ?>" target="_blank" class="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-sm text-white bg-emerald-600 hover:bg-emerald-500 transition-all shrink-0 flex items-center justify-center gap-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-12 border-b border-slate-200 dark:border-white/10">
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        <a href="/" class="flex items-center gap-3">
                            <img src="<?php echo e(asset('images/logo2.png')); ?>?v=<?php echo e(time()); ?>" alt="أوردر سيف" class="h-10 w-auto max-h-10 object-contain">
                            <span class="text-2xl font-black tracking-tight text-slate-900 dark:text-white font-sans">
                                <span x-show="lang === 'ar'">أوردر سيف</span>
                                <span x-show="lang === 'en'">Order Saif</span>
                            </span>
                    ...
                    <div class="lg:col-span-3 space-y-4">
                        ...
                        <div class="space-y-3 text-sm text-slate-700 dark:text-gray-300">
                            <a href="<?php echo e($phoneContact?->action_url ?? ($whatsappContact ? 'tel:'.$whatsappContact->phone_number : '#')); ?>" class="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-brand-500/50 transition-all">
                                ...
                                <div>
                                    ...
                                    <div class="font-bold text-slate-900 dark:text-white font-mono"><?php echo e($phoneContact?->phone_number ?? ($whatsappContact?->phone_number ?? '')); ?></div>
                                </div>
                            </a>
                            <a href="<?php echo e($whatsappContact?->action_url ?? '#'); ?>" target="_blank" class="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-emerald-500/50 transition-all">
                                ...
                                <div>
                                    ...
                                    <div class="font-bold text-slate-900 dark:text-white font-mono text-xs"><?php echo e($whatsappContact?->phone_number ?? 'تواصل عبر واتساب'); ?></div>
                                </div>
                            </a>
    ...
    <a href="<?php echo e($whatsappContact?->action_url ?? '#'); ?>" 
       target="_blank" 
...
<?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/index.blade.php ENDPATH**/ ?>