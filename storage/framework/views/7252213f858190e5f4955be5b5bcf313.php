                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-center text-sm align-middle">
                        ...
                        <tbody>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $sortedGovernorates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $governorate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr id="governorate-row-<?php echo e($governorate->id); ?>" class="border-b even:bg-gray-50 <?php echo e(!$governorate->is_active ? 'opacity-60' : ''); ?>">
                                <td class="py-3 px-3 align-middle text-center text-sm"><?php echo e($i + 1); ?></td>
                                <td class="py-3 px-3 align-middle text-center">
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" 
                                               <?php echo e($governorate->is_active ? 'checked' : ''); ?>

                                               class="sr-only peer toggle-switch" 
                                               data-id="<?php echo e($governorate->id); ?>"
                                               onchange="toggleGovernorate(<?php echo e($governorate->id); ?>)">
                                ...
                                <td class="py-3 px-3 align-middle text-center">
                                    <div class="font-medium text-gray-900 text-sm"><?php echo e($governorate->name); ?></div>
                                </td>
                                <td class="py-3 px-3 align-middle text-center">
                                    <div class="text-gray-900 text-sm"><?php echo e($governorate->price); ?> جنيه</div>
                                </td>
                                <td class="py-3 px-3 align-middle text-center">
                                    <span class="status-text text-sm font-medium <?php echo e($governorate->is_active ? 'text-green-600' : 'text-red-600'); ?>">
                                        <?php echo e($governorate->is_active ? 'متاح' : 'غير متاح'); ?>

                                    </span>
                                </td>
                                <td class="py-3 px-3 align-middle text-center">
                                    <button onclick="openEditModal(<?php echo e($governorate->id); ?>, '<?php echo e($governorate->name); ?>', <?php echo e($governorate->price); ?>)" 
...
</script><?php /**PATH E:\programing\flutter project\fast order\resources\views\shipping\index.blade.php ENDPATH**/ ?>