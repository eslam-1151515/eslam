...
<head>
    ...
    <title>حسابي - <?php echo e($tenant->name); ?></title>
...
<body class="theme-default classic-theme">
    ...
    <div class="top-bar">
        ...
        <div class="store-brand">🛍️ <span><?php echo e($tenant->name); ?></span></div>
        ...
        <div class="account-grid">
            ...
            <main class="content-card">
                ...
                <div class="tab-content" id="tab-account-settings">
                    ...
                    <p style="color: var(--text-muted); font-size: 0.95rem;">يمكنك من هنا إدارة حالة حسابك في متجر <?php echo e($tenant->name); ?>. يرجى الملاحظة أن بعض الإجراءات لا يمكن التراجع عنها.</p>
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\default\account.blade.php ENDPATH**/ ?>