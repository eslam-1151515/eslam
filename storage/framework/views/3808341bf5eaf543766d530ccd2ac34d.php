<?php $__env->startSection('title', 'اتصل بنا | أوردر سيف (Order Saif) - دعم فني متواصل 24/7'); ?>

<?php $__env->startSection('meta_description', 'تواصل مع فريق الدعم الفني أو المبيعات في أوردر سيف. نحن هنا لمساعدتك في الإجابة على استفساراتك وتوسيع نطاق مبيعات متجرك.'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 space-y-8">
                ...
                <div class="glass-card p-8 rounded-2xl border-white/5 space-y-6">
                    ...
                    <div class="space-y-4">
                        <a href="<?php echo e(($phoneContact ?? null)?->action_url ?? (($whatsappContact ?? null) ? 'tel:'.($whatsappContact->phone_number ?? '') : '#')); ?>" class="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-brand-500/30 transition-all">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-white font-mono mt-0.5"><?php echo e(($phoneContact ?? null)?->phone_number ?? (($whatsappContact ?? null)?->phone_number ?? '01146520922')); ?></div>
                            </div>
                        </a>

                        <a href="<?php echo e(($whatsappContact ?? null)?->action_url ?? '#'); ?>" target="_blank" class="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-emerald-500/30 transition-all">
                            ...
                            <div>
                                ...
                                <div class="font-bold text-white font-mono mt-0.5 text-sm"><?php echo e(($whatsappContact ?? null)?->phone_number ?? 'تواصل عبر واتساب'); ?></div>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="glass-card p-8 rounded-2xl border-emerald-500/20 bg-emerald-950/10 text-center space-y-4">
                    ...
                    <a href="<?php echo e(($whatsappContact ?? null)?->action_url ?? '#'); ?>" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-white bg-emerald-600 hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-500/25">
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/contact.blade.php ENDPATH**/ ?>