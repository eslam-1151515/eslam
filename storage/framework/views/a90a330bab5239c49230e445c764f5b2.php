...
<head>
    ...
    <title><?php echo e($landingPage->seo_title ?? ($landingPage->title ?? 'عرض خاص')); ?> | <?php echo e($tenant->name ?? 'المتجر الرسمي'); ?></title>
    <meta name="description" content="<?php echo e($landingPage->seo_description ?? ($landingPage->title ?? 'صفحة هبوط حصرية بعروض وخصومات مميزة')); ?>">
    ...
    <?php if($fbPixelId): ?>
        ...
        <noscript>
            <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?php echo e($fbPixelId); ?>&ev=PageView&noscript=1" />
        </noscript>
    ...
    <meta property="og:title" content="<?php echo e($landingPage->seo_title ?? ($landingPage->title ?? 'عرض خاص')); ?>">
    <meta property="og:description" content="<?php echo e($landingPage->seo_description ?? ($landingPage->title ?? 'صفحة هبوط حصرية بعروض وخصومات مميزة')); ?>">
    <meta property="og:image" content="<?php echo e($landingPage->featured_image ?? ($tenant->logo ? asset($tenant->logo) : '')); ?>">
    ...
    <style>
        :root {
            --primary: <?php echo e($theme['primary_color'] ?? '#6c63ff'); ?>;
            --secondary: <?php echo e($theme['secondary_color'] ?? '#ff6584'); ?>;
            --accent: #ffb703;
            --dark: #0f172a;
            --light: #f8fafc;
        ...
        *:focus-visible {
        ...
        .hero-section.has-bg-image .hero-title {
            background: <?php echo e($isDarkTheme ? 'linear-gradient(to right, #fff, #cbd5e1)' : 'linear-gradient(to right, #0f172a, #334155)'); ?> !important;
        ...
        .hero-section.has-bg-image .hero-subtitle {
            color: <?php echo e($isDarkTheme ? '#e2e8f0' : '#475569'); ?> !important;
        }
        ...
        <?php echo $landingPage->custom_css; ?>

    </style>
</head>
<body class="template-<?php echo e($landingPage->template ?? 'classic'); ?>">
    ...
    <!-- Nav -->
    <nav class="landing-nav" aria-label="<?php echo e(__('ملاحة المتجر الرئيسية')); ?>">
        <div class="store-logo">
            <i class="fa-solid fa-store" aria-hidden="true"></i>
            <span><?php echo e($tenant->name ?? 'المتجر الرسمي'); ?></span>
        </div>
    ...
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($type === 'hero'): ?>
            <?php
                $heroOverlay = !empty($section['bg_image']) 
                    ...
                    : '';
            ?>
            <section class="hero-section <?php echo e(!empty($section['bg_image']) ? 'has-bg-image' : ''); ?>" style="<?php echo e($heroOverlay); ?>">
                <?php if(!empty($section['badge'])): ?>
                    <div class="hero-badge"><?php echo e($section['badge']); ?></div>
                <?php endif; ?>
                <h1 class="hero-title"><?php echo e($section['title'] ?? 'عنوان العرض الرئيسي'); ?></h1>
                <p class="hero-subtitle"><?php echo e($section['subtitle'] ?? ''); ?></p>
                
                <a href="<?php echo e($section['cta_link'] ?? '#product-showcase'); ?>" aria-label="<?php echo e($section['cta_text'] ?? 'اطلب الآن واكسب الخصم'); ?>" class="btn-cta track-conversion" data-slug="<?php echo e($landingPage->slug); ?>">
                    <span><?php echo e($section['cta_text'] ?? 'اطلب الآن واكسب الخصم'); ?></span>
        ...
        <?php if($type === 'countdown'): ?>
            <section class="countdown-section" aria-label="<?php echo e($section['title'] ?? 'ينتهي هذا العرض خلال'); ?>">
                <div class="countdown-title">
                    <i class="fa-solid fa-clock text-amber-400" aria-hidden="true"></i>
                    <span><?php echo e($section['title'] ?? 'ينتهي هذا العرض خلال:'); ?></span>
                    <?php if(!empty($section['offer_badge'])): ?>
                        <span class="save-badge"><?php echo e($section['offer_badge']); ?></span>
                    <?php endif; ?>
                </div>
                <div class="countdown-grid" aria-live="off" data-endtime="<?php echo e($section['end_time'] ?? date('Y-m-d H:i:s', strtotime('+24 hours'))); ?>">
                    <div class="time-box">
                ...
                <?php if(!empty($section['text'])): ?>
                    <p style="color: #94a3b8; margin-top: 1.2rem; font-weight: 600;"><?php echo e($section['text']); ?></p>
                <?php endif; ?>
            </section>
        <?php endif; ?>

        <!-- 3. Product Showcase -->
        <?php if($type === 'product_showcase'): ?>
            <?php
            ...
            ?>
            <section class="showcase-section" id="product-showcase" aria-label="<?php echo e($section['title'] ?? 'المنتج المميز'); ?>">
                <div class="section-header">
                    <h2 class="section-title"><?php echo e($section['title'] ?? 'المنتج المميز'); ?></h2>
                ...
                <div class="product-card">
                    <div class="product-image-wrap">
                        <?php if($discountPercent > 0): ?>
                            <div class="discount-ribbon">وفر <?php echo e($discountPercent); ?>%</div>
                        <?php endif; ?>

                        <?php if(!empty($pData['images']) && count($pData['images']) > 1): ?>
                            <script>
                                window.galleryImages = <?php echo json_encode($pData['images'] ?? (!empty($pImg) ? [$pImg] : [])); ?>;
                            </script>
                            <!-- Gallery Carousel -->
                            <div class="product-gallery-slider">
                                <div class="slider-track" id="slider-track">
                                    <?php $__currentLoopData = $pData['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgIndex => $gImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="slide-item">
                                            <img src="<?php echo e($gImg); ?>" alt="<?php echo e($pName); ?> - <?php echo e($imgIndex + 1); ?>" onclick="openLightbox(<?php echo e($imgIndex); ?>)" style="cursor: pointer;">
                                        </div>
                                ...
                                <div class="slider-dots">
                                    <?php $__currentLoopData = $pData['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgIndex => $gImg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="dot <?php echo e($imgIndex === 0 ? 'active' : ''); ?>" onclick="goToSlide(<?php echo e($imgIndex); ?>)"></span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        <?php else: ?>
                            <script>
                                window.galleryImages = <?php echo json_encode(!empty($pImg) ? [$pImg] : []); ?>;
                            </script>
                            <img src="<?php echo e($pImg); ?>" alt="<?php echo e($pName); ?>" class="product-img" onclick="openLightbox(0)" style="cursor: pointer;">
                        <?php endif; ?>
                    </div>

                    <div class="product-details">
                        <h3><?php echo e($pName); ?></h3>
                        <p class="product-desc"><?php echo e($pDesc); ?></p>

                        <div class="price-container">
                            <span class="current-price"><?php echo e(number_format($pPrice)); ?> <?php echo e($curr); ?></span>
                            <?php if($pOldPrice > $pPrice): ?>
                                <span class="old-price"><?php echo e(number_format($pOldPrice)); ?> <?php echo e($curr); ?></span>
                                <span class="save-badge">وفرت <?php echo e(number_format($pOldPrice - $pPrice)); ?> <?php echo e($curr); ?></span>
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if(!empty($pData) && isset($pData['id'])): ?>
                            <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '<?php echo e($pData['id']); ?>')" aria-label="<?php echo e($section['buy_button_text'] ?? 'اطلب الآن واكسب الخصم'); ?>" class="btn-cta" style="width: 100%; cursor: pointer;">
                                <span><?php echo e($section['buy_button_text'] ?? 'اطلب الآن - دفع عند الاستلام'); ?></span>
                                <i class="fa-solid fa-cart-shopping" aria-hidden="true"></i>
                            </button>
                        <?php else: ?>
        ...
        <?php if($type === 'features'): ?>
            <section class="features-section" aria-label="<?php echo e($section['title'] ?? 'لماذا تختارنا'); ?>">
                <div class="section-header">
                    <h2 class="section-title"><?php echo e($section['title'] ?? 'لماذا تختارنا؟'); ?></h2>
                    <p class="section-subtitle"><?php echo e($section['subtitle'] ?? ''); ?></p>
                </div>

                <div class="features-grid">
                    <?php $__currentLoopData = ($section['features'] ?? ($section['items'] ?? [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="feature-card">
                            <div class="feature-icon" aria-hidden="true">
                                <i class="<?php echo e($item['icon'] ?? 'fa-solid fa-star'); ?>"></i>
                            </div>
                            <h3 class="feature-title"><?php echo e($item['title'] ?? ''); ?></h3>
                            <p class="feature-desc"><?php echo e($item['description'] ?? ($item['desc'] ?? '')); ?></p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </section>
        ...
        <?php if($type === 'testimonials'): ?>
            <section class="testimonials-section" aria-label="<?php echo e($section['title'] ?? 'آراء العملاء'); ?>">
                <div class="section-header">
                    <h2 class="section-title"><?php echo e($section['title'] ?? 'آراء عملائنا'); ?></h2>
                    <p class="section-subtitle"><?php echo e($section['subtitle'] ?? ''); ?></p>
                </div>

                <div class="testimonials-grid">
                    <?php $__currentLoopData = ($section['testimonials'] ?? ($section['items'] ?? [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="testimonial-card">
                            <div class="stars" aria-label="<?php echo e(__('تقييم :rating من 5 نجوم', ['rating' => $testi['rating'] ?? 5])); ?>">
                                <?php for($i = 0; $i < ($testi['rating'] ?? 5); $i++): ?>
                                    <i class="fa-solid fa-star" aria-hidden="true"></i>
                                <?php endfor; ?>
                            </div>
                            <p class="quote-text">"<?php echo e($testi['comment'] ?? ''); ?>"</p>
                            <div class="user-meta">
                                <?php if(!empty($testi['avatar'])): ?>
                                    <img src="<?php echo e($testi['avatar']); ?>" alt="<?php echo e($testi['name'] ?? ''); ?>" class="user-avatar">
                                <?php else: ?>
                                    <div class="user-avatar" aria-hidden="true" style="background: var(--primary); display:flex; align-items:center; justify-content:center; color:#fff; font-weight:bold;">
                                        <?php echo e(mb_substr($testi['name'] ?? 'ع', 0, 1)); ?>

                                    </div>
                                <?php endif; ?>
                                <div class="user-info">
                                    <h4><?php echo e($testi['name'] ?? 'عميل موثق'); ?></h4>
                                    <span>
                                        <i class="fa-solid fa-circle-check" aria-hidden="true"></i>
                                        <?php echo e($testi['role'] ?? 'مشتري مؤكد'); ?>
        ...
        <!-- 6. CTA Banner -->
        <?php if($type === 'cta'): ?>
            <section class="cta-banner" aria-label="<?php echo e($section['title'] ?? 'دعوة لاتخاذ إجراء'); ?>">
                <h2 class="cta-title"><?php echo e($section['title'] ?? 'هل أنت جاهز للطلب؟'); ?></h2>
                <p class="cta-subtitle"><?php echo e($section['subtitle'] ?? ''); ?></p>
                <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '')" aria-label="<?php echo e($section['button_text'] ?? 'اطلب الآن واكسب العرض'); ?>" class="btn-white">
                    <span><?php echo e($section['button_text'] ?? 'اطلب الآن واكسب العرض'); ?></span>
        ...
        <section class="checkout-section-bottom" id="checkout-form-section">
            <div class="checkout-form-container-bottom">
                ...
                <div id="checkout-form-container" class="landing-checkout-form-wrap">
                    <form id="landing-checkout-form" class="landing-checkout-form" onsubmit="submitLandingOrder(event, '<?php echo e($landingPage->slug); ?>', '<?php echo e($showcaseProduct['id']); ?>', '<?php echo e($showcaseProduct['name']); ?>', '<?php echo e($showcaseProduct['price']); ?>')">
                        ...
                        <div class="form-group">
                            ...
                            <div class="quantity-tiers-grid">
                                ...
                                <label class="tier-option-card active">
                                    <input type="radio" name="qty_tier" value="1" checked required onclick="selectQtyTier(1, <?php echo e($showcaseProduct['price']); ?>, 'قطعة واحدة')">
                                    <div class="tier-info">
                                        <span class="title">قطعة واحدة</span>
                                        <span class="desc">بسعر العرض المميز</span>
                                    </div>
                                    <div class="tier-price">
                                        <strong><?php echo e(number_format($showcaseProduct['price'])); ?></strong> <?php echo e($curr); ?>

                                    </div>
                                </label>

                                <!-- Custom tiers from database if available -->
                                <?php if(!empty($showcaseProduct['price_tiers']) && is_array($showcaseProduct['price_tiers'])): ?>
                                    <?php $__currentLoopData = $showcaseProduct['price_tiers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <label class="tier-option-card">
                                            <input type="radio" name="qty_tier" value="<?php echo e($qty); ?>" onclick="selectQtyTier(<?php echo e($qty); ?>, <?php echo e($totalPrice); ?>, '<?php echo e($tierName); ?>')">
                                            <div class="tier-info">
                                                <span class="title"><?php echo e($tierName); ?></span>
                                                <span class="desc">توفير رائع وشحن مجاني!</span>
                                            </div>
                                            <div class="tier-price">
                                                <strong><?php echo e(number_format($totalPrice)); ?></strong> <?php echo e($curr); ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <label class="tier-option-card">
                                        <input type="radio" name="qty_tier" value="2" onclick="selectQtyTier(2, <?php echo e($showcaseProduct['price'] * 2 * 0.9); ?>, 'عرض قطعتين (خصم 10%)')">
                                        <div class="tier-info">
                                            <span class="title">عرض قطعتين (خصم 10%)</span>
                                            <span class="desc">وفر <?php echo e(number_format($showcaseProduct['price'] * 2 * 0.1)); ?> ج.م + شحن مجاني!</span>
                                        </div>
                                        <div class="tier-price">
                                            <strong><?php echo e(number_format($showcaseProduct['price'] * 2 * 0.9)); ?></strong> <?php echo e($curr); ?>

                                        </div>
                                    </label>
                                    <label class="tier-option-card">
                                        <input type="radio" name="qty_tier" value="3" onclick="selectQtyTier(3, <?php echo e($showcaseProduct['price'] * 3 * 0.8); ?>, 'عرض 3 قطع (خصم 20%)')">
                                        <div class="tier-info">
                                            <span class="title">عرض 3 قطع (خصم 20% - الأكثر طلباً)</span>
                                            <span class="desc">وفر <?php echo e(number_format($showcaseProduct['price'] * 3 * 0.2)); ?> ج.م + شحن مجاني!</span>
                                        </div>
                                        <div class="tier-price">
                                            <strong><?php echo e(number_format($showcaseProduct['price'] * 3 * 0.8)); ?></strong> <?php echo e($curr); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select id="governorate_id" name="governorate_id" required onchange="handleGovernorateChange(this)">
                                ...
                                <?php $__currentLoopData = $governorates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gov->id); ?>" data-shipping="<?php echo e($gov->price); ?>"><?php echo e($gov->name); ?> (+<?php echo e($gov->price); ?> ج.م شحن)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
    ...
    ?>
    <div class="sticky-bar" role="complementary" aria-label="<?php echo e(__('شريط الشراء السريع')); ?>">
        <div class="sticky-price">
            <span>سعر العرض المحدود:</span>
            <strong><?php echo e($stickyPrice); ?></strong>
        </div>
        <button onclick="handleOrderClick('<?php echo e($landingPage->slug); ?>', '')" aria-label="<?php echo e(__('اطلب الآن بسعر')); ?> <?php echo e($stickyPrice); ?>" class="sticky-btn">
            <span>اطلب الآن</span>
    ...
    <!-- Footer -->
    <footer>
        <p>جميع الحقوق محفوظة &copy; <?php echo e(date('Y')); ?> لـ <?php echo e($tenant->name ?? 'المتجر الرسمي'); ?> | تم التطوير بواسطة Fast Order</p>
    </footer>

    <!-- Scripts -->
    <script>
        // Global variables for dynamic variant selections and pricing
        window.productColors = <?php echo json_encode($showcaseProduct['colors'] ?? [], 15, 512) ?>;
        window.productSizes = <?php echo json_encode($showcaseProduct['sizes'] ?? [], 15, 512) ?>;
        window.productPrice = <?php echo e($showcaseProduct['price'] ?? 0); ?>;
        window.productShippingType = '<?php echo e($showcaseProduct['shipping_type'] ?? 'free'); ?>';
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views/shop/landing.blade.php ENDPATH**/ ?>