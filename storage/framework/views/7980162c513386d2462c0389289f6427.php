<?php $__env->startSection('title', 'شروط الخدمة | فاست أوردر (Fast Order) - التزامات وقواعد واضحة'); ?>

<?php $__env->startSection('meta_description', 'اقرأ شروط وأحكام استخدام منصة فاست أوردر لبناء المتاجر الإلكترونية، وقواعد الاستخدام المقبول وحقوق الملكية الفكرية والالتزامات المالية.'); ?>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\fast order\resources\views\platform\terms.blade.php ENDPATH**/ ?>