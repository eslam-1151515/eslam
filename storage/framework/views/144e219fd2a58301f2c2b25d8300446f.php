...
<head>
    ...
    <title>تم الطلب بنجاح - <?php echo e($tenant->name ?? 'المتجر'); ?></title>
  ...
  <link rel="stylesheet" href="/shop/themes/starter/style.css?v=1.0.0">
    ...
    <style>
        :root {
            ...
            --secondary: <?php echo e($theme['secondary_color']); ?>;
        }
...
<body class="theme-starter fast-theme">
    ...
    <div class="success-card">
        ...
        <div class="order-badge">
            رقم الطلب: <?php echo e($order->reference_number); ?>
        ...
        <div class="order-details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value" dir="ltr"><?php echo e($order->customer_phone); ?></span>
            </div>
            <div class="detail-row">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">
                    <?php echo e($order->payment_method === 'cod' ? 'الدفع عند الاستلام' : 'تحويل إلكتروني'); ?>
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo e(number_format($order->shipping_cost, 0)); ?> ج.م</span>
            </div>
            <?php endif; ?>
            <div class="detail-row">
                <span class="detail-label">الإجمالي</span>
                <span class="detail-value" style="color:var(--primary); font-size:1rem;">
                    <?php echo e(number_format($order->total, 0)); ?> ج.م
                </span>
            </div>
            <div class="detail-row">
        ...
        <button class="items-toggle" onclick="toggleItems(this)">
            عرض تفاصيل المنتجات (<?php echo e(count($items)); ?>) <i class="fas fa-chevron-down" style="font-size:0.75rem;"></i>
        </button>
        <div class="items-list" id="items-list">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="item-entry">
                <span><?php echo e($item['name']); ?> <span style="color:#888;">× <?php echo e($item['quantity']); ?></span></span>
                <span style="font-weight:700;"><?php echo e(number_format($item['total'] ?? ($item['price'] * $item['quantity']), 0)); ?> ج.م</span>
            </div>
        ...
        <div class="transfer-box">
            ...
            حوّل المبلغ <strong><?php echo e(number_format($order->total, 0)); ?> ج.م</strong> إلى:<br>
        ...
        <div class="actions">
            ...
            <a href="/shop/order-success.html?ref=<?php echo e($order->reference_number); ?>" class="btn btn-secondary">
...
function toggleItems(btn) {
    ...
    btn.innerHTML = list.classList.contains('open')
        ...
        : 'عرض تفاصيل المنتجات (<?php echo e(count($items ?? [])); ?>) <i class="fas fa-chevron-down" style="font-size:.75rem;"></i>';
}
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\starter\order-success.blade.php ENDPATH**/ ?>