<?php $__env->startSection('title', 'اتفاقية مستوى الخدمة (SLA) | فاست أوردر (Fast Order) - استقرار وضمان لأعمالك'); ?>

<?php $__env->startSection('meta_description', 'تعرف على التزامات منصة فاست أوردر بخصوص وقت تشغيل الخوادم (Uptime)، والتعويضات المستحقة، ومستويات الدعم الفني لضمان استمرارية متجرك الإلكتروني.'); ?>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\fast order\resources\views\platform\sla.blade.php ENDPATH**/ ?>