...
<?php endif; ?>
        ...
        <?php
            ...
            $logoutRoute = (request()->getHost() === 'app.' . $appHost) ? 'superadmin.logout' : 'merchant.logout';
        ?>
        <form method="POST" action="<?php echo e(route($logoutRoute)); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH E:\programing\flutter project\fast order\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>