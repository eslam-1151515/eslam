...
<head>
    ...
    <title>إتمام الطلب - <?php echo e($tenant->name ?? 'المتجر'); ?></title>
  ...
  <link rel="stylesheet" href="/shop/themes/default/style.css?v=1.0.0">
    ...
    <style>
        :root {
            ...
            --font:      '<?php echo e($theme['font_family']); ?>', 'Cairo', sans-serif;
        }
...
<body class="theme-default classic-theme">
    ...
    <nav class="topbar">
        <a href="/shop/" class="topbar-brand"><?php echo e($tenant->name ?? 'المتجر'); ?></a>
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\shop\themes\default\checkout.blade.php ENDPATH**/ ?>