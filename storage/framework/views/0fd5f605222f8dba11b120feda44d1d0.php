<?php $__env->startSection('title', 'شروط الخدمة | أوردر سيف (Order Saif) - التزامات وقواعد واضحة'); ?>

<?php $__env->startSection('meta_description', 'اقرأ شروط وأحكام استخدام منصة أوردر سيف لبناء المتاجر الإلكترونية، وقواعد الاستخدام المقبول وحقوق الملكية الفكرية والالتزامات المالية.'); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="glass-card p-8 md:p-12 rounded-3xl border-white/5 space-y-10 leading-relaxed text-gray-300">
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm sm:text-base">
                    تُقدم المنصة "كما هي" وبدون أي ضمانات صريحة أو ضمنية بخصوص ملاءمتها لغرض معين. أوردر سيف غير مسؤولة عن أي خسائر مالية مباشرة أو غير مباشرة، أو فقدان بيانات، أو تعطل أعمال يواجهه التاجر أو عملائه نتيجة استخدام أو عدم القدرة على استخدام المنصة.
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <p class="text-sm sm:text-base">
                    جميع الحقوق والملكيات الفكرية الخاصة بالمنصة وتصميمها وشفرتها البرمجية وعلامتها التجارية تنتمي حصرياً لشركة أوردر سيف. بالمقابل، يمتلك التاجر كامل الحقوق والملكية الفكرية للمحتوى والمنتجات والصور التي يرفعها على متجره الإلكتروني الخاص.
                </p>
            </div>
...
<?php echo $__env->make('layouts.platform', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\programing\flutter project\eslam system\resources\views/platform/terms.blade.php ENDPATH**/ ?>