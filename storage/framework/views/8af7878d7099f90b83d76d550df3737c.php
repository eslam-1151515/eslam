            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <?php if(isset($item['selectedSize']) || isset($item['selectedColor']) || isset($item['size']) || isset($item['color']) || isset($item['options'])): ?>
                            <br><small style="color: #6b7280;">
                                ...
                                <?php if(isset($item['options']) && is_array($item['options'])): ?>
                                    <?php $__currentLoopData = $item['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optK => $optV): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($optV): ?> | <?php echo e($optK); ?>: <?php echo e($optV); ?> <?php endif; ?>
