...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('إدارة الطلبات')); ?></h2>
     <?php $__env->endSlot(); ?>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                        <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['total']); ?></p>
                        </div>
                        <div class="bg-gradient-to-r from-yellow-500 to-orange-500 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['pending']); ?></p>
                        </div>
                        <div class="bg-gradient-to-r from-green-500 to-green-600 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['confirmed']); ?></p>
                        </div>
                        <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['shipped']); ?></p>
                        </div>
                        <div class="bg-gradient-to-r from-purple-500 to-purple-600 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['delivered']); ?></p>
                        </div>
                        <div class="bg-gradient-to-r from-red-500 to-red-600 p-4 rounded-xl shadow-lg text-white text-center">
                            ...
                            <p class="text-3xl font-bold"><?php echo e($statusCounts['cancelled']); ?></p>
                        </div>
                    </div>

                    <!-- Search and Filter Bar -->
                    <div class="bg-gray-50 p-5 rounded-xl mb-4">
                        <form method="GET" action="<?php echo e(route('orders.index')); ?>" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3 items-end">
                            <!-- Search -->
                            <div>
                            ...
                            <div>
                                ...
                                <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500">
                                    ...
                                    <option value="shipped"   <?php echo e(request('status') == 'shipped'   ? 'selected' : ''); ?>>في التوصيل</option>
                            ...
                            <div class="flex gap-2">
                                ...
                                <a href="<?php echo e(route('orders.index')); ?>" class="px-3 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 text-sm flex items-center" title="إلغاء الفلتر">
                    ...
                    <div class="flex justify-end gap-3 mb-4">
                        <a href="<?php echo e(route('orders.export', array_merge(request()->all(), ['format' => 'excel']))); ?>"
                           class="inline-flex items-center gap-2 bg-emerald-600 text-white px-5 py-2.5 rounded-lg hover:bg-emerald-700 transition duration-200 font-medium shadow">
                            ...
                            تحميل Excel
                            <?php if(request()->hasAny(['search','date_from','date_to','status','product_id'])): ?>
                                <span class="text-xs bg-emerald-500 px-2 py-0.5 rounded-full">(مفلتر)</span>
                            <?php endif; ?>
                        </a>
                        <a href="<?php echo e(route('orders.export', array_merge(request()->all(), ['format' => 'pdf']))); ?>" target="_blank"
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50 transition duration-150 <?php echo e($order->status === 'cancelled' ? 'bg-red-50 opacity-75' : ''); ?>" id="order-row-<?php echo e($order->id); ?>">
                                            <td class="px-4 py-3 whitespace-nowrap text-sm font-bold text-gray-900">
                                                <?php echo e($orders->firstItem() + $index); ?>

                                            </td>
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <div class="text-sm font-bold text-indigo-600"><?php echo e($order->reference_number); ?></div>
                                            </td>
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->customer_phone); ?></td>
                                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900"><?php echo e($order->governorate); ?></td>
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                <select onchange="updateOrderStatus(<?php echo e($order->id); ?>, this.value)"
                                                        data-original-value="<?php echo e($order->status); ?>"
                                                        class="text-xs font-semibold rounded-full px-3 py-1 border-0 focus:ring-2 focus:ring-blue-500 status-select-<?php echo e($order->status); ?>">
                                                    ...
                                                    <option value="shipped"   <?php echo e($order->status == 'shipped'   ? 'selected' : ''); ?>>في التوصيل</option>
                                            ...
                                            <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-500">
                                                <div><?php echo e($order->created_at->format('Y/m/d')); ?></div>
                                                <div class="text-xs text-gray-400"><?php echo e($order->created_at->format('h:i A')); ?></div>
                                            </td>
                                            <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center gap-1">
                                                    ...
                                                    <button onclick="printInvoice(<?php echo e($order->id); ?>)"
                        ...
                        <div class="px-6 py-4 bg-gradient-to-r from-emerald-50 to-teal-50 border-t border-emerald-200">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-2xl font-bold text-emerald-700 bg-white px-4 py-2 rounded-lg shadow-sm border border-emerald-200">
                                    <?php echo e(number_format($totalAmount, 0)); ?> <span class="text-sm text-emerald-600">EGP</span>
                                </div>
                            </div>
                        </div>
...
<?php endif; ?>
<?php /**PATH E:\programing\flutter project\fast order\resources\views\orders\index.blade.php ENDPATH**/ ?>