...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <form method="POST" action="<?php echo e(route('products.store')); ?>" class="text-right" enctype="multipart/form-data" id="productForm">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                    <label class="block mb-1 font-medium">اسم المنتج <span class="text-red-500">*</span></label>
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-indigo-200" required>
                    ...
                    <div class="relative">
                        <select name="category_id" class="w-full border rounded-lg p-2 pr-8 focus:ring-2 focus:ring-indigo-200" required style="-webkit-appearance: none; -moz-appearance: none; appearance: none; background-image: none;">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($id); ?>" <?php if(old('category_id')==$id): echo 'selected'; endif; ?>><?php echo e($name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_before" value="<?php echo e(old('price_before', 0)); ?>" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-indigo-200">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_after" value="<?php echo e(old('price_after', 0)); ?>" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-indigo-200" required>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <input type="radio" id="free_shipping" name="shipping_type" value="free" 
                                   ...
                                   <?php echo e(old('shipping_type', 'free') == 'free' ? 'checked' : ''); ?>>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input type="radio" id="governorate_shipping" name="shipping_type" value="governorate" 
                                       class="w-4 h-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                                       <?php echo e(old('shipping_type') == 'governorate' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="stock" value="<?php echo e(old('stock', 0)); ?>" class="w-full border rounded-lg p-2 focus:ring-2 focus:ring-indigo-200">
...
<?php /**PATH E:\programing\flutter project\fast order\resources\views\products\create.blade.php ENDPATH**/ ?>