...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            تفاصيل ثيم <?php echo e($theme->name); ?>
    ...
    <div class="py-6 font-sans text-right" dir="rtl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <a
                    href="<?php echo e(url('/merchant/themes/marketplace')); ?>"
                ...
                <div class="text-xs text-slate-400">
                    سوق الثيمات / تفاصيل الثيم / <?php echo e($theme->name); ?>
                    ...
                    <div class="space-y-4 text-right max-w-3xl flex-1">
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="px-3 py-1 rounded-full text-xs font-black shadow-md <?php echo e($theme->type === 'free' ? 'bg-emerald-500 text-white' : 'bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-950'); ?>">
                                <?php echo e($theme->type === 'free' ? '🎁 مجاني تماماً' : '💎 ثيم بريميوم'); ?>
                            ...
                            <span class="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-slate-300 text-xs font-medium">
                                الإصدار <?php echo e($theme->version); ?>
                        ...
                        <div class="flex items-center gap-4 text-xs md:text-sm text-slate-400">
                            <span>المطور: <strong class="text-white"><?php echo e($theme->author); ?></strong></span>
                            ...
                            <span class="flex items-center gap-1">
                                ...
                                <span>(<?php echo e($theme->reviews_count ?? 0); ?> تقييم)</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 text-center w-full lg:w-80 space-y-4 shrink-0 shadow-lg">
                        <div class="space-y-1">
                            ...
                            <div class="text-3xl font-black text-white">
                                <?php if($theme->type === 'free'): ?>
                                    <span class="text-emerald-400">مجاني بالكامل</span>
                                <?php else: ?>
                                    <span><?php echo e($theme->price); ?> <span class="text-lg font-normal text-slate-300"><?php echo e($theme->currency ?? 'ج.م'); ?></span></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="pt-2 space-y-3">
                            ...
                            <?php else: ?>
                                <form action="<?php echo e(url('/merchant/themes/marketplace/' . $theme->slug . '/install')); ?>" method="POST" onsubmit="showInstallLoader(this)">
                                    <?php echo csrf_field(); ?>
                                    <button
                                        type="submit"
                                    ...
                                    >
                                        <span>⚡</span>
                                        <span><?php echo e($theme->type === 'paid' ? 'شراء وتفعيل الثيم' : 'تفعيل الثيم الآن'); ?></span>
                                    </button>
                                </form>
                            <?php endif; ?>
            ...
            <div class="flex border-b border-slate-200 mb-8 bg-white p-1.5 rounded-2xl shadow-sm">
                ...
                <button onclick="switchTab('reviews')" id="tab-btn-reviews" class="section-tab-btn flex-1 py-3 text-center text-sm font-black rounded-xl transition-all duration-200 text-slate-500 hover:text-slate-800">
                    التقييمات والتعليقات (<?php echo e($theme->reviews_count ?? 0); ?>)
                </button>
            </div>
                ...
                <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-6">
                            ...
                            <div class="rounded-2xl border-4 border-slate-800 overflow-hidden shadow-xl relative aspect-video bg-slate-900">
                                ...
                                <div class="bg-slate-800 py-2 px-4 text-center text-[10px] font-mono flex items-center justify-between shrink-0 text-slate-450 text-slate-400">
                                    ...
                                    <span class="text-slate-300">fastorder.eg/shop/preview/<?php echo e($theme->slug); ?></span>
                                    <span>معاينة سريعة</span>
                                </div>

                                <!-- Simulated Preview Body -->
                                <div class="w-full h-full bg-gradient-to-tr <?php echo e($gradientClass); ?> flex flex-col items-center justify-center p-8 text-center text-white relative">
                                    ...
                                    <div class="relative z-10 space-y-3 max-w-md">
                                        ...
                                        <h3 class="text-xl md:text-2xl font-black tracking-wide"><?php echo e($theme->name); ?></h3>
                    ...
                    <div id="section-features" class="section-content hidden space-y-6">
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <?php if(is_array($theme->features)): ?>
                                    <?php $__currentLoopData = $theme->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-start gap-3 p-4 rounded-2xl bg-emerald-50/50 border border-emerald-500/20 shadow-sm">
                                            ...
                                            <span class="text-sm font-semibold text-slate-700 leading-relaxed"><?php echo e($feat); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php if(is_array($theme->compatibility)): ?>
                                    <?php $__currentLoopData = $theme->compatibility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-3 text-sm text-slate-600 bg-slate-50 p-4 rounded-2xl border border-slate-200/60">
                                            ...
                                            <span class="font-medium"><?php echo e($comp); ?></span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </div>
                    ...
                    <div id="section-reviews" class="section-content hidden space-y-6">
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                                ...
                                <div class="text-center md:border-l border-slate-200 py-4">
                                    <div class="text-5xl font-black text-amber-500"><?php echo e($theme->rating ?? '5.0'); ?></div>
                                    <div class="flex justify-center text-amber-400 text-lg my-2">
                                        ★ ★ ★ ★ ★
                                    </div>
                                    <div class="text-xs text-slate-500">
                                        إجمالي التقييمات: <?php echo e($theme->reviews_count ?? 0); ?> مراجعة
                                    </div>
                                </div>
                                    ...
                                    <?php $__currentLoopData = [5, 4, 3, 2, 1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center gap-3 text-xs font-semibold">
                                            <span class="w-12 text-slate-500 flex items-center gap-1 justify-end">
                                                <span><?php echo e($stars); ?> نجوم</span>
                                            </span>
                                            ...
                                            <span class="w-14 text-slate-400 text-left">
                                                <?php echo e($pct); ?>% (<?php echo e($count); ?>)
                                            </span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
                            ...
                            <form action="<?php echo e(url('/merchant/themes/marketplace/' . $theme->slug . '/review')); ?>" method="POST" class="bg-slate-50 p-5 rounded-2xl border border-slate-200 space-y-4">
                                <?php echo csrf_field(); ?>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                        ...
                        <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
                            <h2 class="text-lg font-black text-slate-800 pb-3 border-b border-slate-100">
                                💬 آراء ومراجعات التجار الفعليين (<?php echo e(count($reviews)); ?>)
                            </h2>
                                            ...
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center gap-3">
                                                    <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-orange-500 to-amber-500 text-white font-black text-sm flex items-center justify-center shadow-inner">
                                                        <?php echo e(mb_substr($rev['reviewer'] ?? 'ت', 0, 1)); ?>

                                                    </div>
                                                    <div>
                                                        <span class="text-sm font-bold text-slate-800 block"><?php echo e($rev['reviewer'] ?? 'تاجر فاست أوردر'); ?></span>
                                                        <span class="text-[10px] text-slate-400"><?php echo e($rev['date'] ?? ''); ?></span>
                                                    </div>
                                                </div>
                                                <div class="flex items-center text-amber-400 font-black text-sm text-xs">
                                                    <?php $starsCount = (int) ($rev['rating'] ?? 5); ?>
                                                    <?php echo str_repeat('★', $starsCount); ?>

                                                    <?php echo str_repeat('☆', 5 - $starsCount); ?>
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-4">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex items-center justify-between py-2 border-b border-slate-100">
                                ...
                                <span class="font-bold text-slate-800"><?php echo e($theme->author); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-2 border-b border-slate-100">
                                <span class="text-slate-500 font-medium">نوع الترخيص:</span>
                                <span class="px-2 py-0.5 rounded text-xs font-bold <?php echo e($theme->type === 'free' ? 'bg-emerald-100 text-emerald-600' : 'bg-amber-100 text-amber-600'); ?>">
                                    <?php echo e($theme->type === 'free' ? 'مجاني' : 'مدفوع بريميوم'); ?>
                            ...
                            <div class="flex items-center justify-between py-2 border-b border-slate-100">
                                ...
                                <span class="font-bold text-slate-800">
                                    <?php echo e($theme->type === 'free' ? '0.00 EGP' : $theme->price . ' ' . ($theme->currency ?? 'EGP')); ?>

                                </span>
                            </div>
                            <div class="flex items-center justify-between py-2 border-b border-slate-100">
                                <span class="text-slate-500 font-medium">الإصدار الحالي:</span>
                                <span class="font-bold text-slate-800"><?php echo e($theme->version); ?></span>
                            </div>
                            <div class="flex items-center justify-between py-2 border-b border-slate-100">
                                <span class="text-slate-500 font-medium">متوسط التقييمات:</span>
                                <span class="font-bold text-amber-500">★ <?php echo e($theme->rating ?? '5.0'); ?> / 5.0</span>
                            </div>
                            <div class="flex items-center justify-between py-2">
                                <span class="text-slate-500 font-medium">عدد المراجعات:</span>
                                <span class="font-bold text-slate-800"><?php echo e($theme->reviews_count ?? 0); ?> مراجعة</span>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH E:\programing\flutter project\fast order\resources\views\merchant\themes\marketplace_show.blade.php ENDPATH**/ ?>