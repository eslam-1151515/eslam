...
export default function WhatsAppIndex({ settings = {}, summary = {}, merchants = [] }) {
    ...
    const [form, setForm] = useState({
        ...
        meta_webhook_verify_token: settings.meta_webhook_verify_token || 'ordersaif_wa_secret_2026',
                                        ...
                                        <tr key={merchant.id} className="hover:bg-gray-50/80 transition-colors">
                                            <td className="py-3.5 px-4">
                                                ...
                                                <div className="text-[11px] text-gray-500 flex items-center gap-2 mt-0.5">
                                                    ...
                                                    <span>•</span>
                                                    <span className="font-mono text-indigo-600">{merchant.subdomain}.ordersaif.com</span>
                                                </div>
                                            </td>
