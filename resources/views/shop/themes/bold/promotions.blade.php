...
<head>
    ...
    <meta name="description" content="????? ???? ???? ?????? ??? ????????? ???????? ??????? ?? {{ $tenant->name ?? '??????' }}. ???? ???? ????? ??????? ??? ???? ??????!">
                        ...
                        <div class="promo-header {{ $promo->type === 'flash_sale' ? 'flash' : '' }}">
                            <div class="promo-info">
                                ...
                                <div style="display: flex; align-items: center; gap: 0.75rem; margin-top: 0.5rem;">
                                    ...
                                    <span class="discount-highlight">??? {{ $promo->discount_badge_text }}</span>
                                </div>
                            </div>
                                ...
                                @foreach($promo->products_list as $product)
                                    <div class="product-card">
                                        ...
                                        @if($product->saved_percentage && $product->saved_percentage !== '0%')
                                            <div class="badge-save">??? {{ $product->saved_percentage }}</div>
                                        @endif
                                        ...
                                        <div class="product-details">
                                            ...
                                            <div class="price-container">
                                                <span class="new-price">{{ number_format($product->discounted_price ?? $product->price, 0) }} ?.?</span>
