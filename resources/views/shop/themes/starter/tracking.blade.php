        ...
        <section class="search-hero">
            ...
            <form action="{{ url('/tracking') }}" method="GET" class="search-form">
                <div class="input-group">
                    <input type="text" name="order_number" class="form-control" placeholder="??? ????? (????: 12345)" value="{{ $orderRef ?? '' }}" required>
                    <i class="fas fa-hashtag"></i>
                </div>
                <div class="input-group">
                    <input type="text" name="phone" class="form-control" placeholder="??? ?????? ?? ?????? ??????????" value="{{ $contact ?? '' }}" required>
            ...
            <section class="tracking-card">
                ...
                <div class="order-header">
                    ...
                    <div class="order-dates">
                        @if(!empty($trackingResult['created_at']))
                            <span><i class="fas fa-calendar-alt"></i> ????? ?????: <strong>{{ $trackingResult['created_at'] }}</strong></span>
                        @endif
                        @if(!empty($trackingResult['updated_at']))
                            <span><i class="fas fa-clock"></i> ??? ?????: <strong>{{ $trackingResult['updated_at'] }}</strong></span>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="info-card">
                        ...
                        <ul class="info-list">
                            <li class="info-item">
                                ...
                                <span class="info-val">{{ number_format($trackingResult['subtotal'], 0) }} ?.?</span>
                            </li>
                            <li class="info-item">
                                <span class="info-label"><i class="fas fa-shipping-fast"></i> ????? ?????:</span>
                                <span class="info-val">{{ $trackingResult['shipping_cost'] > 0 ? number_format($trackingResult['shipping_cost'], 0) . ' ?.?' : '?????' }}</span>
                            </li>
                            <li class="info-item summary-total">
                                <span class="info-label" style="color: var(--primary);"><i class="fas fa-calculator"></i> ???????? ?????:</span>
                                <span class="info-val">{{ number_format($trackingResult['total'], 0) }} ?.?</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="products-section">
                    <div class="products-card">
                        <h3 class="info-card-title">
                            <i class="fas fa-boxes"></i> ???????? ???????? ({{ count($trackingResult['items']) }})
                        </h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="product-meta">
                                            @if(!empty($item['selectedSize']))
                                                <span class="meta-pill">??????: {{ $item['selectedSize'] }}</span>
                                            @endif
                                            @if(!empty($item['selectedColor']))
                                                <span class="meta-pill">?????: {{ $item['selectedColor'] }}</span>
                                            @endif
                                            <span class="meta-pill">??????: {{ $item['quantity'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="product-price-wrap">
                                    <div class="product-qty">{{ number_format($item['price'], 0) }} × {{ $item['quantity'] }}</div>
                                    <div class="product-total">{{ number_format($item['total'], 0) }} ?.?</div>
                                </div>
                            </div>
                            @endforeach
                        </div>
