...
<head>
    ...
    <title>تسجيل تاجر جديد - {{ config('app.name', 'أوردر سيف') }}</title>
...
<body class="min-h-screen flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8 relative">
    ...
    <header class="max-w-5xl mx-auto w-full flex items-center justify-between mb-8">
        <div class="flex items-center gap-3">
            ...
            <div>
                <span class="text-2xl font-black tracking-tight bg-gradient-to-l from-white via-gray-200 to-brand-300 bg-clip-text text-transparent">أوردر سيف</span>
    ...
    <footer class="max-w-4xl mx-auto w-full text-center mt-8 text-xs text-gray-500">
        <p>© {{ date('Y') }} أوردر سيف (Order Saif). جميع الحقوق محفوظة. بتسجيلك أنت توافق على <a href="#" class="text-gray-400 underline">شروط الخدمة</a> و <a href="#" class="text-gray-400 underline">سياسة الخصوصية</a>.</p>
    </footer>
