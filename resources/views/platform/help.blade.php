...
@section('title', 'مركز المساعدة والشروحات | أوردر سيف (Order Saif) - دليلك للنجاح')

@section('meta_description', 'تصفح شروحات ودليل استخدام منصة أوردر سيف. تعلم كيفية إنشاء متجرك، وإضافة منتجاتك، وتفعيل إعدادات الدفع والشحن، وربط دومين مخصص بسهولة.')
