                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                ...
                                @if($settings['logo'])
                                    <img id="logoPreview" src="{{ asset('storage/' . $settings['logo']) }}" alt="Logo"
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div class="flex gap-3 items-center">
                                    <input type="color" name="secondary_color" value="{{ $settings['secondary_color'] ?? '#64748b' }}"
                                        class="h-10 w-20 border border-gray-300 rounded-lg cursor-pointer">
                                    <input type="text" value="{{ $settings['secondary_color'] ?? '#64748b' }}" readonly
                                        class="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm bg-gray-50 font-mono text-center">
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="font_family" class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                                    <option value="Cairo" {{ ($settings['font_family'] ?? '') === 'Cairo' ? 'selected' : '' }}>Cairo (الافتراضي)</option>
                        ...
                        <div class="flex flex-col md:flex-row gap-6 items-start border-t pt-4">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                ...
                                @if(isset($settings['favicon']) && $settings['favicon'])
                                    <img id="faviconPreview" src="{{ asset('storage/' . $settings['favicon']) }}" alt="Favicon"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                                    ...
                                    <input type="url" name="facebook_page" value="{{ $settings['facebook_page'] }}"
                        ...
                        <div>
                            ...
                            @if($settings['facebook_pixel_id'])
                                <div class="mt-2 flex items-center gap-2 text-green-700 text-sm bg-green-50 rounded-lg px-3 py-2">
                                    ...
                                    <span>الـ Pixel مفعّل على الموقع - ID: <span class="font-mono font-bold">{{ $settings['facebook_pixel_id'] }}</span></span>
                                </div>
                            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        ...
                        <div>
                            ...
                            @if(isset($settings['tiktok_pixel_id']) && $settings['tiktok_pixel_id'])
                                <div class="mt-2 flex items-center gap-2 text-green-700 text-sm bg-green-50 rounded-lg px-3 py-2">
                                    <i class="fa fa-circle-check"></i>
                                    <span>الـ Pixel مفعّل على الموقع - ID: <span class="font-mono font-bold">{{ $settings['tiktok_pixel_id'] }}</span></span>
                                </div>
                            @else
                                <div class="mt-2 flex items-center gap-2 text-gray-500 text-sm bg-gray-50 rounded-lg px-3 py-2">
                                    <i class="fa fa-circle-xmark"></i>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6">
                        ...
                        <div id="mainCategoriesList" class="space-y-2 mb-3">
                            @foreach($settings['main_categories'] as $idx => $cat)
