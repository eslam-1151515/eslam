...
/*
|--------------------------------------------------------------------------
| Super Admin / Merchant Registration Auth Routes
| Domain: app.fastorder.test
|--------------------------------------------------------------------------
*/

// Merchant registration routes on the main domain
Route::get('register', [RegisteredUserController::class, 'create'])->name('register');
Route::post('register', [RegisteredUserController::class, 'store'])->middleware('throttle:register');
Route::get('check-subdomain', [RegisteredUserController::class, 'checkSubdomain'])->name('check.subdomain');

Route::middleware('guest')->group(function () {
    Route::get('login', [SuperAdminSessionController::class, 'create'])
        ->name('login');

    Route::post('login', [SuperAdminSessionController::class, 'store'])
