...
- **المسار الرئيسي للموقع (Document Root):** `/home/ordersaif.com/deploy/current/public`
- **مجلد التحديثات (Releases):** `/home/ordersaif.com/deploy/releases/` (يحتوي على النسخ برقم التاريخ)
- **المجلد المشترك (Shared):** `/home/ordersaif.com/deploy/shared/` (يحتوي على `.env` ومجلد `storage` ليظل ثابتاً ولا يُمحى مع كل تحديث)
...
- قاعدة البيانات تعمل واسمها `OrderSaif_db`.
